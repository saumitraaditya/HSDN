...
class LayeredPolicy:
    ...
    def __call__(self, cameras, linux_computes, num_layers=2, distribution=[1]):
        self.__init__(cameras, linux_computes, num_layers, distribution)
